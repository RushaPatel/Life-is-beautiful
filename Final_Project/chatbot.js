...
input.className="col-lg-4 col-md-6 col-sm-8";
chatbot.appendChild(input);

const submit=document.createElement('button');
submit.innerText="Submit";
submit.setAttribute("id","submit");
submit.className="col-lg-2 col-md-4 col-sm-5 btn btn-primary";
...
function getReply(question) {
  ...
  else if(question==="i failed"){
    answer="Hey,there is no failure in this world,you win one way or another,u just learnt  something new,ok?"
  }
 else if(question==="Someone scolded me"){
   answer="It is possible that they have their reason they might be just trying to make you better,a coal has to be rubbed really hard to become a diamond,ok?"
  }
  else if(question==="someone bullied me"){
    answer="Stand up to them! And tell someone tell your mom or dad or grandparents,ok?"
  ...
  else if(answer==="Stand up to them! And tell someone tell your mom or dad or grandparents,ok?"){
    value1.innerText="ok,um....no"
  }
return answer;}